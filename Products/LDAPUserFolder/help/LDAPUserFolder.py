...
class LDAPUserFolder:
    ...
    def manage_addGroup(newgroup_name, REQUEST):
        """ Add a new group under the group record base. If REQUEST is not
        None a MessageDialog screen will be returned. The group_name argument
        forms the new group CN while the full DN will be formed by combining
        this new CN with the group base DN.
    ...
    def findUser(search_param, search_term):
        ...
        name of an LDAP attribute) and the *search_term* value.
